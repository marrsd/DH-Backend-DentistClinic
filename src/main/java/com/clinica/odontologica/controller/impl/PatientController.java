...
public class PatientController implements CRUDController<PatientDTO> {
        ...
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "201", description = "Patient created", content = {
        ...
        @PostMapping("/new")
        public ResponseEntity<HttpStatus> register(@RequestBody PatientDTO patient)
        ...
        @GetMapping("/id/{id}")
        public ResponseEntity<PatientDTO> searchById(@PathVariable Long id)
        ...
        @GetMapping("/dni/{dni}")
        public ResponseEntity<PatientDTO> searchByDni(@PathVariable Long dni)
                        throws ResourceNotFoundException, IntegrityDataException, NoSuchDataExistsException {
        ...
        @PutMapping("/update")
        public ResponseEntity<PatientDTO> modify(@RequestBody PatientDTO patient)
                        throws ResourceNotFoundException, IntegrityDataException, NoSuchDataExistsException {
        ...
        public ResponseEntity<String> removeByDni(@PathVariable Long dni)
                        throws ResourceNotFoundException, IntegrityDataException, NoSuchDataExistsException {
