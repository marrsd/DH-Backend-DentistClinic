...
public interface CRUDController<T> {
    ResponseEntity<HttpStatus> register(@RequestBody T t) throws ResourceNotFoundException, IntegrityDataException, DataAlreadyExistsException, NoSuchDataExistsException;
